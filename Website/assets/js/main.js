document.addEventListener("DOMContentLoaded", () => {
    ...
    const dictionary = {
        vi: {
            ...
            releaseDesc: "Bản cập nhật này mang đến tính năng được yêu cầu nhiều và cải thiện trải nghiệm tổng thể.",
            releaseItem1: "Tích hợp Widget xem số dư nhanh.",
            releaseItem2: "Bổ sung tùy chọn ẩn/hiện số dư trên Dashboard.",
            releaseItem3: "Cải thiện độ ổn định và tối ưu hóa hiệu năng.",
            ...
            installUpdated: "Cập nhật hướng dẫn: 24/05/2026",
        ...
        en: {
            ...
            releaseDesc: "This update brings a highly requested feature and improves overall stability.",
            releaseItem1: "Integrated balance Widget for quick access.",
            releaseItem2: "Added show/hide balance option on Dashboard.",
            releaseItem3: "Stability improvements and performance optimization.",
            ...
            installUpdated: "Guide updated: May 24, 2026",
            installAndroidTitle: "Android 11+",
