document.addEventListener("DOMContentLoaded", () => {
    ...
    const dictionary = {
        vi: {
            ...
            installIntro: "Bạn có thể cài KAT Budget bằng file APK trên Android. Hoặc sử dụng bản Web App đa nền tảng cho iOS (iPhone/iPad).",
        ...
        en: {
            ...
            installIntro: "You can install KAT Budget on Android using the APK file. Or use the cross-platform Web App for iOS (iPhone/iPad).",
