document.addEventListener("DOMContentLoaded", () => {
    ...
    const dictionary = {
        vi: {
            ...
            releaseKicker: "Phiên bản 1.0.1",
            releaseTitle: "Cập nhật mới có gì?",
            releaseDesc: "Bản cập nhật giúp xem nhanh số dư và bảo vệ quyền riêng tư tốt hơn.",
            releaseItem1: "Nhìn số dư nhanh ở Widget.",
            releaseItem2: "Tính năng ẩn/hiện số dư.",
            releaseItem3: "Tối ưu hóa và cải thiện độ ổn định.",
            ...
            installUpdated: "Cập nhật hướng dẫn: 23/05/2026",
        ...
        en: {
            ...
            releaseKicker: "Version 1.0.1",
            releaseTitle: "What's new?",
            releaseDesc: "This update allows quick balance views and better privacy protection.",
            releaseItem1: "View balance on Widget.",
            releaseItem2: "Show/hide balance feature.",
            releaseItem3: "Optimization and stability improvements.",
            ...
            installIntro: "You can install KAT Budget on Android using the APK file. Or use the cross-platform Web App for iOS (iPhone/iPad) and Desktop (Windows/macOS/Linux).",
            installUpdated: "Guide updated: May 23, 2026",
            installAndroidTitle: "Android 11+",
