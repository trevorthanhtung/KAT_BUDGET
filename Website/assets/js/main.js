document.addEventListener("DOMContentLoaded", () => {
    ...
    const dictionary = {
        vi: {
            ...
            installDesktopText: "Truy cập đường link Web App bằng Chrome hoặc Edge. Nhấn vào biểu tượng 'Tải xuống' ở thanh địa chỉ hoặc chọn 'Cài đặt ứng dụng' từ menu trình duyệt để thêm vào máy tính.",
        ...
        en: {
            ...
            installDesktopTitle: "Windows, macOS, Linux",
            installDesktopText: "Access the Web App link using Chrome or Edge. Click the 'Download' icon in the address bar or select 'Install app' from the browser menu to install it on your computer.",
