document.addEventListener("DOMContentLoaded", () => {
    ...
    const dictionary = {
        vi: {
            ...
            releaseKicker: "Phiên bản 1.0.2",
            releaseTitle: "Cập nhật mới có gì?",
            releaseDesc: "Bản cập nhật này tập trung sửa lỗi dữ liệu tài khoản và tổng dòng tiền.",
            releaseItem1: "Chặn tạo tài khoản trùng tên để tránh gộp ví ngoài ý muốn.",
            releaseItem2: "Khi xóa tài khoản, số dư ban đầu và giao dịch liên quan được dọn khỏi tổng dòng tiền.",
            releaseItem3: "Sửa lỗi giao dịch mồ côi vẫn ảnh hưởng đến tổng tài sản.",
        ...
        en: {
            ...
            releaseKicker: "Version 1.0.2",
            releaseTitle: "What's new?",
            releaseDesc: "This update focuses on account data and cash-flow total fixes.",
            releaseItem1: "Prevent duplicate account names to avoid accidental wallet merging.",
            releaseItem2: "Deleting an account now clears its opening balance and related transactions from totals.",
            releaseItem3: "Fixed orphaned transactions still affecting net worth.",
